...
async def main() -> None:
    ...
    print("```python")
    print("# Canonical delivery schema (AIP-6)")
    print("typed_data = {")
    print("    'domain': {")
    ...
    print("    },")
    print("    'primaryType': 'DeliveryAttestation',")
    print("    'types': {")
    print("        'DeliveryAttestation': [")
    print("            {'name': 'txId', 'type': 'bytes32'},")
    print("            {'name': 'resultCID', 'type': 'string'},")
    print("            {'name': 'resultHash', 'type': 'bytes32'},")
    print("            {'name': 'deliveredAt', 'type': 'uint256'},")
    print("        ]")
    print("    }")
    print("}")
    print("```")
    ...
    print("    eas_config={")
    print("        'delivery_schema_uid': '0x1b0ebdf0...',")
    print("    },")
